...
function SearchResult() {
  ...
  const handleShowSelected = () => {
    // Redirige a la vista de comparación y pasa los productos seleccionados como parte del estado.
    navigate("/comparisonTable", { state: selectedForComparison });
  };
...
//   // const handleShowSelected = () => {
//   //   // Mostrar los productos seleccionados en la consola
//   //   console.log("Productos seleccionados:", selectedForComparison);
//   // };
//   const handleShowSelected = () => {
//     // Redirige a la vista de comparación y pasa los productos seleccionados como parte del estado.
//     navigate("/comparisonTable", { state: selectedForComparison });
...
//         <ComparisonTable selectedProducts={selectedForComparison} />
//       ) : (
